 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://projects.courant.com/closings-delays/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@courant.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Hartford Courant");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for closings and delays");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://projects.courant.com/closings-delays/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@courant.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Hartford Courant");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for closings and delays");
